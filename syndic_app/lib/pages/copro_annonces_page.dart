            ...
            children: [
              ...
              Expanded(
                child: _isLoading 
                  ...
                  : _annoncesList.isEmpty
                    ? Center(child: Text("Aucune annonce pour le moment.", style: TextStyle(color: Colors.blueGrey.shade400)))
                    : ListView.builder(
                          ...
                          return GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: isRead ? Colors.grey.shade200 : aColor.withOpacity(0.3)),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: isRead ? Colors.grey.shade100 : aColor.withOpacity(0.1),
                                      shape: BoxShape.circle,
                                    ),
                                    child: Icon(_getIcon(ann['iconString']), color: isRead ? Colors.grey : aColor, size: 24),
                                  ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                ann["title"], 
                                                style: TextStyle(fontWeight: isRead ? FontWeight.normal : FontWeight.bold, fontSize: 15, color: isRead ? Colors.black54 : Colors.black87)
                                              ),
                                            ),
                                            if (!isRead) 
                                              Container(
                                                ...
                                                child: Text("Nouveau", style: TextStyle(color: Colors.red.shade700, fontSize: 10, fontWeight: FontWeight.bold)),
                                              ),
                                          ],
                                        ),
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(color: isRead ? Colors.grey : aColor, fontSize: 12, fontWeight: isRead ? FontWeight.normal : FontWeight.w600)
                                        ),
                                        const SizedBox(height: 10),
                                        Text(
                                          ann["message"], 
                                          style: TextStyle(color: isRead ? Colors.grey : Colors.black87, fontSize: 13, height: 1.4)
                                        ),
                                      ],
                                    ),
                                  ),
