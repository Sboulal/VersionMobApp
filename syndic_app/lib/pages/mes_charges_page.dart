  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title:  Text("MES CHARGES", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.sp, color: Colors.white)),
          ...
          children: [
            ...
            // 2. Titre de la liste
             Padding(
              ...
              child: Text("Liste des charges chronologiques", style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.bold, color: Colors.black87)),
            ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 2,
                            child: Text(charge["periode"], style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 14.sp, color: Colors.black87)),
                          ),
                          // Séparateur
                          ...
                          Expanded(
                            flex: 3,
                            child: Center(
                              child: Text(charge["montant"], style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.sp, color: Colors.black87)),
                            ),
                          ),
                          // Séparateur
                          Container(height: 16, width: 1, color: Colors.grey.shade300),
